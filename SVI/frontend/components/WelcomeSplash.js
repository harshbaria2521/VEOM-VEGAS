...
export default function WelcomeSplash() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 my-auto flex flex-col items-center text-center animate-fadeIn">
        {/* National Crest Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-400/10 border border-amber-400/30 text-amber-300 text-xs font-semibold uppercase tracking-widest mb-4">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white">
            ...
            <span className="text-amber-400 font-light mx-3">|</span>
            <span className="text-white">Smart Victim Intelligence</span>
          </h1>
          <p className="text-base sm:text-xl text-amber-200/90 font-medium tracking-wide">
            स्मार्ट विक्टिम इंटेलिजेंस
          </p>
        </div>

        {/* Helpline Title */}
        <div className="mt-5 p-3.5 sm:p-4 rounded-xl bg-slate-900/80 border border-slate-700/70 shadow-inner max-w-xl w-full">
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-2.5">
          <span className="inline-flex items-center gap-1 text-xs font-medium bg-emerald-950/60 text-emerald-300 border border-emerald-700/50 px-3 py-1 rounded-full">
            <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
            DPDP 2023 Compliant
          </span>
          <span className="inline-flex items-center gap-1 text-xs font-medium bg-teal-950/60 text-teal-300 border border-teal-700/50 px-3 py-1 rounded-full">
            <Lock className="w-3.5 h-3.5 text-teal-400" />
            256-Bit Anonymized
          </span>
          <span className="inline-flex items-center gap-1 text-xs font-medium bg-amber-950/60 text-amber-300 border border-amber-700/50 px-3 py-1 rounded-full">
